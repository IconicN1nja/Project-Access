        ...
        <div className="flex items-center justify-between pb-4 border-b border-white/10">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-1">
              MacBook Air 13&quot; M4 Specification • Glassmorphism, Floating
              Elevation, and Tactile Micro-Interactions
            </p>
          </div>
          <button
            type="button"
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className={`btn-glass px-3 py-1.5 rounded-full text-xs ${
                forcedIslandState === null
                  ? "border-[#7C3AED] text-[#C4B5FD] bg-[#7C3AED]/15"
                  : "text-zinc-300"
              }`}>
                ...
                <tbody className="divide-y divide-white/5">
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-3">
                      ...
                      <span className="text-[9px] text-[#C4B5FD] block mt-1">
                        Pulsing Glow (Ready)
                      </span>
                    </td>
                  </tr>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4 border-t border-white/10 text-xs">
            <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
              <div className="font-medium text-white mb-1">
                Glassmorphism & Hairline
              </div>
              <div className="text-zinc-400 text-[11px] leading-relaxed">
                Translucent dark surfaces (10–15% opacity over blur), 1px border
                with top specular light-edge.
              </div>
            </div>
            <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
              <div className="font-medium text-white mb-1">
              ...
              <div className="text-zinc-400 text-[11px] leading-relaxed">
                Persistent subtle drop shadow. On hover, buttons physically lift
                2–3px with spring easing.
              </div>
            </div>
            <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
              <div className="font-medium text-white mb-1">Tactile Haptics</div>
              <div className="text-zinc-400 text-[11px] leading-relaxed">
                On click/tap, tactile scale down (0.96–0.98) with instantaneous
                spring rebound.
              </div>
            </div>
          </div>
